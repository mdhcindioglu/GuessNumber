...
namespace GuessNumber
{
    public class GuessNumber
    {
        ...
        private ObservableCollection<ListViewItem> _HumanGuesses;
        public ObservableCollection<ListViewItem> HumanGuesses
        {
            get { return _HumanGuesses; }
            set
            {
                if (_HumanGuesses != value)
                {
                    ObservableCollection<ListViewItem> newValue = value;
                    _HumanGuesses = newValue;
                }
            }
        }

        //List of pc guesses with results
        private ObservableCollection<ListViewItem> _PcGuesses;
        public ObservableCollection<ListViewItem> PcGuesses
        {
            get { return _PcGuesses; }
            set
            {
                if (_PcGuesses != value)
                {
        ...
        public GuessNumber(string myNumber)
        {
            _HumanGuesses = new ObservableCollection<ListViewItem>();
            _PcGuesses = new ObservableCollection<ListViewItem>();
